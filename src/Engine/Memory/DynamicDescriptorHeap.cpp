    ...
    , m_NumFreeHandles(0)
{
    ...
    m_DescriptorHandleCache = MakeUnique<D3D12_CPU_DESCRIPTOR_HANDLE[]>(m_NumDescriptorsPerHeap);
}
...
void DynamicDescriptorHeap::StageDescriptors(u32 rootParameterIndex, u32 offset, u32 numDescriptors,
...
void DynamicDescriptorHeap::StageInlineCBV(u32 rootParameterIndex, D3D12_GPU_VIRTUAL_ADDRESS bufferLocation)
{
...
void DynamicDescriptorHeap::StageInlineSRV(u32 rootParameterIndex, D3D12_GPU_VIRTUAL_ADDRESS bufferLocation)
{
    assert(rootParameterIndex < MaxDescriptorTables);
...
void DynamicDescriptorHeap::StageInlineUAV(u32 rootParamterIndex, D3D12_GPU_VIRTUAL_ADDRESS bufferLocation)
{
