...
using Event = _Delegate<void(EventArgs&)>;
...
using UpdateEvent = _Delegate<void(UpdateEventArgs&)>;
...
using DPIScaleEvent = _Delegate<void(DPIScaleEventArgs&)>;
...
using WindowCloseEvent = _Delegate<void(WindowCloseEventArgs&)>;
...
using KeyboardEvent = _Delegate<void(KeyEventArgs&)>;
...
using MouseMotionEvent = _Delegate<void(MouseMotionEventArgs&)>;
...
using MouseButtonEvent = _Delegate<void(MouseButtonEventArgs&)>;
...
using MouseWheelEvent = _Delegate<void(MouseWheelEventArgs&)>;
...
using ResizeEvent = _Delegate<void(ResizeEventArgs&)>;
...
using UserEvent = _Delegate<void(UserEventArgs&)>;
...
using RuntimeErrorEvent = _Delegate<void(RuntimeErrorEventArgs&)>;
...
using FileChangeEvent = _Delegate<void(FileChangedEventArgs&)>;
