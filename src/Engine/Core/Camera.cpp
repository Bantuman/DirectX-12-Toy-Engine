...
DirectX::XMMATRIX Camera::get_InverseViewProjectionMatrix() const
{
    auto viewProjection = get_ProjectionMatrix() * get_ViewMatrix();
    return XMMatrixInverse(nullptr, viewProjection);
}
