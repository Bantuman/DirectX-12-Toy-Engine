...
#include <Helpers.h>
#include <Engine/Pipeline/ResourceStateTracker.h>
...
void Texture::Resize( u32 width, u32 height, u32 depthOrArraySize )
{
    if ( m_d3d12Resource )
    {
        ...
        ThrowIfFailed( d3d12Device->CreateCommittedResource(
            ADDR(CD3DX12_HEAP_PROPERTIES( D3D12_HEAP_TYPE_DEFAULT )), D3D12_HEAP_FLAG_NONE, &resDesc,
...
void Texture::CreateViews()
{
    if ( m_d3d12Resource )
    {
        ...
        // Create SRV
        bool srv = CheckSRVSupport();
        if ( ( desc.Flags & D3D12_RESOURCE_FLAG_DENY_SHADER_RESOURCE ) == 0 && srv )
        {
...
D3D12_CPU_DESCRIPTOR_HANDLE Texture::GetUnorderedAccessView( u32 mip ) const
{
